...
.. class:: email_auth.forms.AuthenticationForm
   ...
   the :class:`django.contrib.auth.forms.AuthenticationForm` form.
   ...
   the value for the :attr:`authentication_form` argument to the
   :class:`django.contrib.auth.views.login` view::
   ...
   email address is entered in a field called :attr:`username`. This is in
   order to allow templates designed for the default login form to work
   seamlessly with this form.
   ...
   .. function:: clean()
      ...
      login is unsuccessful, a :exc:`django.forms.ValidationError` is
      raised with a message explaining why it did not succeed.
   ...
   .. function:: get_user()
      ...
      Get the user object (an instance of :class:`django.contrib.auth.models.User`)
